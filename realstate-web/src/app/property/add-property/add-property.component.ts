...
export class AddPropertyComponent implements OnInit {
  ...
  // @ViewChild('Form') addPropertyForm: NgForm;  //will use reactiveform instead
  @ViewChild('formTabs') formTabs: TabsetComponent;
  addPropertyForm: FormGroup;  // use reactiveform
  nextClicked: boolean; // to deal with validation that have not loss focus such radio button
  ...
  onSubmit() {
    ...
    if (this.allTabsValid()) {
      this.mapProperty();  // fill property value
  ...
  mapProperty(): void {
    this.property.Id = this.housingService.newPropId(); // generate id
  ...
  // Getter Methos : no param in getter methods
